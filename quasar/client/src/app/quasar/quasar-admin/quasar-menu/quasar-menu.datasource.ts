...
export const QUASAR_MENU_DATASOURCE: QuasarMenu[] = [
  {
    header: 'Geral',
    children: [
      { label: 'Dashboard', router: '/quasar', description: 'Resumo geral da aplicação' },
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Permissões', router: '/user/role', description: 'Controle de responsabilidades no sistema' },
    ]
  },
  {
    header: 'Configuração',
